      ...
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            ...
            <a href={this.docUrl("hooks-useGetDoc.html", this.props.language)}>API Reference</a>
            {/* <a href={this.docUrl("hooks-useLazyGetDoc.html", this.props.language)}>Advanced API</a> */}
          </div>
          {/* <div>
            <h5>Community</h5>
          ...
          <div>
            ...
            <a href="https://github.com/optimind-llc/fire-client">GitHub</a>
            <a
