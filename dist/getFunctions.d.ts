...
export declare function getDocSnapshot(path: string, onGet: (doc: firestore.DocumentSnapshot) => void, onError: (err: any) => void, acceptOutdated?: boolean, saveToState?: boolean): void;
export declare function getDoc(path: string, onGet: (doc: DocData) => void, onError: (err: any) => void, acceptOutdated?: boolean, saveToState?: boolean): void;
...
export declare function getCollectionSnapshot(path: string, onGet: (collection: firestore.DocumentSnapshot[]) => void, onError: (err: any) => void, options?: QueryOptions, acceptOutdated?: boolean, saveToState?: boolean): void;
export declare function getCollection(path: string, onGet: (collection: CollectionData) => void, onError: (err: any) => void, options?: QueryOptions, acceptOutdated?: boolean, saveToState?: boolean): void;
