...
export declare const assertSetDocQueryObject: (obj: any, target?: string) => void;
export declare const assertSetDocQuery: (obj: any, target?: string) => void;
export declare const assertSetCollectionQuery: (obj: any, target?: string) => void;
