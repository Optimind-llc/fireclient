...
import { CollectionData, DocData, HooksId, QueryOption, SetDocQuery } from ".";
...
export declare function useSetDoc(path: string, query: SetDocQuery, option: any): (boolean | ((...args: any) => void) | null)[];
export declare function useAddDoc(path: string, query: SetDocQuery, option: any): (boolean | ((...args: any) => void) | null)[];
export declare function useUpdateDoc(path: string, query: SetDocQuery, option: any): (boolean | ((...args: any) => void) | null)[];
