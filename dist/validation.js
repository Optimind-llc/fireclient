...
exports.isAnyOf = function(candidate) {
...
exports.isArrayOf = function(rule) {
  return function(obj, target) {
    ...
    return notMatched.length > 0
      ? {
          ...
          message:
            target +
            ' should be array and every element should satisfy below.\n"' +
...
exports.matchesArrayOf = function(rule) {
  return function(obj, target) {
    if (!Array.isArray(obj)) {
      return {
        valid: false,
...
exports.matchesObjectOf = function(rule) {
  return function(obj, target) {
    if (Array.isArray(obj)) {
      return {
        valid: false,
...
exports.queryOptionRule = [
  {
    key: "where",
    optional: true,
    fn: exports.condition(
      function(obj) {
        return !Array.isArray(obj);
      },
      exports.matches(whereRule),
      exports.matchesArrayOf(whereRule),
    ),
  },
  {
    key: "limit",
  ...
  },
  {
    ...
    fn: exports.condition(
      ...
      exports.matches(orderRule),
      exports.matchesArrayOf(orderRule),
    ),
  },
  {
    key: "cursor",
...
exports.assertRule = function(rule) {
  return function(obj, target) {
...
var assertSetCollectionSchemaOjbect = function(obj, target) {
  ...
  obj.forEach(function(ele) {
    return exports.assertSetDocSchema(ele);
  });
};
exports.assertSetCollectionSchema = function(obj, target) {
  if (target === void 0) {
    target = "SetCollectionSchema";
  }
  if (!(obj instanceof Function)) {
...
exports.assertSubCollectionQuery = function(obj, target) {
  ...
  values.forEach(function(value) {
    ...
    value.forEach(function(ele) {
      return exports.assertSetDocSchemaObject(ele, "Element");
    });
  });
};
