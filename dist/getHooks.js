...
function useLazyGetDoc(path, options) {
    return useGetDocBase(path, exports.initialDocData, true, getFunctions_1.getDoc, options);
}
exports.useLazyGetDoc = useLazyGetDoc;
function useGetDoc(path, options) {
    return useGetDocBase(path, exports.initialDocData, false, getFunctions_1.getDoc, options);
}
...
function useLazyGetCollection(path, options) {
    return useGetCollectionBase(path, exports.initialCollectionData, true, getFunctions_1.getCollection, options);
}
exports.useLazyGetCollection = useLazyGetCollection;
function useGetCollection(path, options) {
    return useGetCollectionBase(path, exports.initialCollectionData, false, getFunctions_1.getCollection, options);
}
